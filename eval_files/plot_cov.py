...
model.load_state_dict(torch.load("model_cov.pt"))  # Load weights
...
ax.set_title(f"Cover type 3-D finetuned autoencoder latent space K = {K}", pad=18)
...
plt.savefig("cov_finetrained3d.png", dpi=300, bbox_inches='tight')
