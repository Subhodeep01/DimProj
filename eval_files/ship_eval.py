...
model.load_state_dict(torch.load("model_ship_pretrain.pt"))  # Load weights
...
ax.set_title(f"Ship 3-D just autoencoder latent space K = {K}", pad=18)
...
plt.savefig("ship_pretrained3d.png", dpi=300, bbox_inches='tight')
